...
* [CVE-2024-41473](http/cves/2024/CVE-2024-41473.yaml)
...
* [方天云智慧平台系统 Upload.ashx 存在任意文件上传漏洞](http/vulnerabilities/fangdee/fangdee-upload-file-upload.yaml)
...
* [飞企互联 FE 企业运营管理平台 uploadAttachmentServlet 存在任意文件上传漏洞](http/vulnerabilities/flyrise/flyrise-fe-uploadAttachmentServlet-uploadfile.yaml)
...
* [广联达OA 系统 GetSSOStamp 接口存在任意用户登录](http/vulnerabilities/glodon/glodon-oa-getsso-stamp-login.yaml)
* [广联达OA 系统接口 ConfigService.asmx 存在 SQL 注入漏洞](http/vulnerabilities/glodon/glodon-oa-configservice-sqli.yaml)
...
* [宏景 eHR 人力资源管理系统接口 LoadOtherTreeServlet 存在 SQL 注入漏洞](http/vulnerabilities/hjsoft/hjsoft-hcm-loadothertree-sqli.yaml)
* [宏景 eHR 人力资源管理系统接口 getSdutyTree 存在 SQL 注入漏洞](http/vulnerabilities/hjsoft/hjsoft-hcm-getsdutytree-sqli.yaml)
* [宏景 eHR 人力资源管理系统接口 loadtree 存在 SQL 注入漏洞](http/vulnerabilities/hjsoft/hjsoft-hcm-loadtree-sqli.yaml)
...
* [蓝凌EIS DingUsers.aspx 存在 SQL 注入漏洞](http/vulnerabilities/landray/landray-eis-dingusers-sqli.yaml)
...
* [致远互联 AnalyticsCloud 分析云存在任意文件读取漏洞](http/vulnerabilities/seeyon/seeyon-analyticscloud-lfi.yaml)
...
* [万户 ezOFFICE 协同管理平台 getautocode.jsp 存在 SQL 注入漏洞](http/vulnerabilities/wanhu/wanhu-ezoffice-getautocode-sqli.yaml)
...
* [泛微OA E-Cology v9系统接口 ModeDateService 存在 SQL 漏洞](http/vulnerabilities/weaver/ecology/ecology-v9-modedateservice-sqli.yaml)
...
* [用友时空 KSOA PreviewKPQT 存在SQL 注入漏洞](http/vulnerabilities/yonyou/yonyou-ksoa-previewkpqt-sqli.yaml)
...
* [用友 NC U9 UMWebService.asmx 任意文件读取漏洞](http/vulnerabilities/yonyou/yonyou-u9-umwebservice-fileread.yaml)
...
* [用友 NC 接口 download 存在 SQL 注入漏洞](http/vulnerabilities/yonyou/yonyou-nc-download-sqli.yaml)
